...
import '../../../viewmodels/segundo_bimestre_viewmodel.dart';
import '../../../models/segundo_bimestre_model.dart'; // AÑADIR ESTE IMPORT

class SegundoBimestreScreen extends StatelessWidget {
  const SegundoBimestreScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SegundoBimestreViewModel(),
      child: const _SegundoBimestreScreenContent(),
    );
  }
}

class _SegundoBimestreScreenContent extends StatelessWidget {
  const _SegundoBimestreScreenContent();

  @override
  Widget build(BuildContext context) {
    final viewModel = context.watch<SegundoBimestreViewModel>();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: viewModel.getBlueAccentColor(context),
  ...
  Widget _buildBimestreInfo(
    ...
    SegundoBimestreViewModel viewModel,
  ) {
    return Container(
      padding: const EdgeInsets.all(16),
      color: viewModel.getBlueLightColor(context),
      child: Row(
        children: [
          Container(
            width: 4,
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                    color: viewModel.getBlueAccentColor(context),
                  ),
                ),
              ),
            ],
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      viewModel.estudianteSeleccionado ==
                                          estudiante.item
                                      ? viewModel.getBlueAccentColor(context)
                                      : null,
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border:
                                      viewModel.estudianteSeleccionado ==
                                          estudiante.item
                                      ? Border.all(
                                          color: viewModel.getBlueAccentColor(
                                            context,
                                          ),
                                          width: 2,
                                        )
  ...
  Widget _buildCeldaAsistencia(
    ...
    switch (fecha) {
      ...
      case 'ABR-V':
        ...
        break;
      case 'MAY-L':
        valor = estudiante.mayL;
        break;
      case 'MAY-M':
        valor = estudiante.mayM;
        break;
      case 'MAY-MI':
        valor = estudiante.mayMi;
        break;
      case 'MAY-J':
        valor = estudiante.mayJ;
        break;
      case 'MAY-V':
        valor = estudiante.mayV;
        break;
      case 'JUN-L':
        valor = estudiante.junL;
        break;
      case 'JUN-M':
        valor = estudiante.junM;
        break;
      case 'JUN-MI':
        valor = estudiante.junMi;
        break;
      case 'JUN-J':
        valor = estudiante.junJ;
        break;
      case 'JUN-V':
        valor = estudiante.junV;
        break;
      case 'JUL-L':
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              'Cerrar',
              style: TextStyle(color: viewModel.getBlueAccentColor(context)),
            ),
          ),
        ],
      ),
