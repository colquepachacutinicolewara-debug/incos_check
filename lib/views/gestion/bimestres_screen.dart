...
// import '../../viewmodels/bimestre_viewmodel.dart';
...
//       create: (context) => BimestreViewModel(),
//       child: Scaffold(
...
//           actions: [
//             Consumer<BimestreViewModel>(
//               builder: (context, viewModel, child) {
//                 return IconButton(
//                   icon: const Icon(Icons.refresh),
//                   onPressed: () {
//                     viewModel.cargarBimestres();
//                   },
//                 );
//               },
//             ),
//           ],
//         ),
//         body: Consumer<BimestreViewModel>(
//           builder: (context, viewModel, child) {
...
//             if (viewModel.bimestres.isEmpty) {
//               return Center(
//                 child: Column(
//                   mainAxisAlignment: MainAxisAlignment.center,
//                   children: [
...
//               children: viewModel.bimestres.map((bimestre) {
...
//                   final success = await viewModel.editarBimestreCompleto(
//                     periodo.id,
...
//                   onTap: () {
//                     Navigator.pop(context);
//                     viewModel.cambiarEstadoBimestre(periodo.id, 'En Curso');
...
//                   onTap: () {
//                     Navigator.pop(context);
//                     viewModel.cambiarEstadoBimestre(periodo.id, 'Finalizado');
//                     _mostrarSnackBar(context, '✅ Estado actualizado', Colors.green);
//                   },
//                 ),
//             ],
...
//           TextButton(
//             onPressed: () async {
//               final success = await viewModel.eliminarBimestre(periodo.id);
//               if (success && context.mounted) {
//                 Navigator.pop(context);
...
class _BimestresScreenState extends State<BimestresScreen> {
  ...
  void _navigateToBimestreDetalle(PeriodoAcademico bimestre, BuildContext context) {
    switch (bimestre.numero) {
      case 1:
        _navigateToPrimerBimestre(context);
        break;
      case 2:
        Navigator.push(
          context,
  ...
  void _navigateToPrimerBimestre(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MultiProvider(
          providers: [
            ...
            ChangeNotifierProvider(create: (context) => PrimerBimestreViewModel()),
          ],
          child: const PrimerBimestreScreen(),
        ),
      ),
    );
  }
