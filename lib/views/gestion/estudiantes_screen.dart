...
import '../biometrico/registro_huella_simple_screen.dart';
...
class _EstudiantesListContentState extends State<_EstudiantesListContent> {
  ...
  void _registrarHuellas(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RegistroHuellaSimpleScreen(
                ...
                Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Paralelo Dropdown
                      DropdownButtonFormField<String>(
                        initialValue: _selectedParaleloId,
                        decoration: const InputDecoration(
                          labelText: 'Paralelo *',
                          border: OutlineInputBorder(),
                        ),
